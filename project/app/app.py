...
# ============================================
MEDECINS = {
    "dr.martin@hospital.ma":   {"password": "medecin123", "nom": "Dr. Martin"},
    "dr.benali@hospital.ma":   {"password": "medecin123", "nom": "Dr. Benali"},
    "dr.zerhouni@centrale.ma": {"password": "admin2026",  "nom": "Dr. Zerhouni"},
}
...
if page == "🔐 Connexion":
    ...
    with col_form:
        ...
        email    = st.text_input("📧 Email professionnel", placeholder="dr.nom@hospital.ma")
        ...
        st.markdown("""
        <hr><p style="color:#666;font-size:0.83rem;text-align:center;">
        Comptes de démo :<br>
        📧 dr.benali@hospital.ma / 🔑 medecin123<br>
        📧 dr.zerhouni@centrale.ma / 🔑 admin2026
